...
void main() {
  ...
  group('pickImageFromCamera', () {
    ...
    test(
      'should throw Exception and log warning if camera permission denied',
      () async {
        // ARRANGE
        when(
    ...
    test(
      'should return null and not throw if permission granted but no image picked',
      () async {
        // ARRANGE
        when(
          mockPermissionService.requestCameraPermission(),
    ...
    test(
      'should return File if permission granted and image is picked',
      () async {
        // ARRANGE
        when(
          mockPermissionService.requestCameraPermission(),
    ...
    test(
      'should rethrow and log error if ImagePicker throws an exception',
      () async {
        // ARRANGE
  ...
  group('pickImageFromGallery', () {
    ...
    test(
      'should throw Exception and log warning if gallery permission denied',
      () async {
        // ARRANGE
        when(
          mockPermissionService.requestGalleryPermission(),
        ).thenAnswer((_) async => false);
    ...
    test(
      'should return null if permission granted but no image picked from gallery',
      () async {
        // ARRANGE
        when(
          mockPermissionService.requestGalleryPermission(),
    ...
    test(
      'should return File if permission granted and image is picked from gallery',
      () async {
        // ARRANGE
        when(
          mockPermissionService.requestGalleryPermission(),
    ...
    test(
      'should use provided parameters when picking image from gallery',
      () async {
        // ARRANGE
